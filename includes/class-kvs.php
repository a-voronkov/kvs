...
class Kvs {
	...
	public function register_kvs_settings() {
		...
		register_setting( 'kvs-settings-group-taxonomy', 'kvs_taxonomy_category' );
		register_setting( 'kvs-settings-group-taxonomy', 'kvs_taxonomy_tag' );
		register_setting( 'kvs-settings-group-taxonomy', 'kvs_taxonomy_model' );
		register_setting( 'kvs-settings-group-taxonomy', 'kvs_taxonomy_source' );
	...
	public function register_post_type() {
		...
		$labels = array(
			...
			'not_found' => __( 'No videos found', 'kvs' ),
		...
		$labels = array(
			'name' => __( 'Video sources', 'kvs' ),
			'singular_name' => __( 'Video source', 'kvs' ),
			'menu_name' => __( 'Sources', 'kvs' ),
			'all_items' => __( 'All sources', 'kvs' ),
			'edit_item' => __( 'Edit source', 'kvs' ),
			'view_item' => __( 'View source', 'kvs' ),
			'update_item' => __( 'Update source name', 'kvs' ),
			'add_new_item' => __( 'Add new source', 'kvs' ),
			'new_item_name' => __( 'New source name', 'kvs' ),
			'parent_item' => __( 'Parent source', 'kvs' ),
			'parent_item_colon' => __( 'Parent source:', 'kvs' ),
			'search_items' => __( 'Search sources', 'kvs' ),
			'popular_items' => __( 'Popular sources', 'kvs' ),
			'separate_items_with_commas' => __( 'Separate sources with commas', 'kvs' ),
			'add_or_remove_items' => __( 'Add or remove sources', 'kvs' ),
			'choose_from_most_used' => __( 'Choose from the most used sources', 'kvs' ),
			'not_found' => __( 'No sources found', 'kvs' ),
			'no_terms' => __( 'No sources', 'kvs' ),
			'items_list_navigation' => __( 'Sourcess list navigation', 'kvs' ),
			'items_list' => __( 'KVS sources list', 'kvs' ),
			'back_to_items' => __( 'Back to sources', 'kvs' ),
		);
		$args = array(
			'label' => __( 'Video sources', 'kvs' ),
			'labels' => $labels,
			'public' => true,
			'publicly_queryable' => false,
			'hierarchical' => false,
